...
| My tasks | Read sprint MD, find cards with `**Assignee:** WEB` |
...
1. Read sprint MD, find cards with `**Assignee:** WEB`: Check assigned tasks
...
2. Read sprint MD, find cards with `**Assignee:** WEB` for assigned tasks
