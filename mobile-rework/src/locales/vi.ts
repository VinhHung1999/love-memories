...
const vi = {
  ...
  onboarding: {
    ...
    coupleForm: {
      title: 'Đặt tên cho mái ấm',
      subtitle: 'Tên · khẩu hiệu · ngày bắt đầu',
      nameLabel: 'Tên gọi của hai đứa',
      namePlaceholder: 'Linh & Minh',
      sloganLabel: 'Khẩu hiệu (tuỳ ý)',
      sloganPlaceholder: 'Khẩu hiệu của hai đứa…',
      sloganRemaining: 'Còn {{n}} ký tự',
      dateLabel: 'Ngày hai đứa bắt đầu',
      datePlaceholder: '14.02.2023',
      cta: 'Tạo mái ấm',
      saving: 'Đang lưu…',
      errors: {
        nameRequired: 'Đặt cho hai đứa một cái tên nhé.',
        nameTooLong: 'Tên hơi dài — gọn lại tí nhé.',
        sloganTooLong: 'Khẩu hiệu hơi dài — gọn lại tí nhé.',
    ...
    personalize: {
      ...
      nickLabel: 'Tên gọi',
      nickPlaceholder: 'Linh',
      nickIcon: '✶',
      colorLabel: 'Chọn một sắc',
      previewPlaceholder: 'tên của em',
      cta: 'Tiếp',
      saving: 'Đang lưu…',
      avatarAdd: 'Thêm ảnh',
