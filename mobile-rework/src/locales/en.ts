...
const en: Resources = {
  ...
  onboarding: {
    ...
    coupleForm: {
      ...
      subtitle: 'A date, a name, a line',
      required: 'Required',
      optional: 'Optional',
      dateLabel: 'Anniversary',
      datePlaceholder: '14.02.2023',
      dateHelp: 'The day you became you. Shows up every morning.',
      nameLabel: 'Couple name',
      nameIcon: '♡',
      namePlaceholder: 'Ourcouple',
      nameSuggestions: ['Us two', 'Our nest', 'Ourcouple', 'Two of us'],
      sloganLabel: 'Your line',
      sloganIcon: '✎',
      sloganPlaceholder: 'a tiny line',
      sloganSuggestions: ['the long way home', 'two of us', 'us, against the rest'],
      cta: 'Create invite',
      saving: 'Saving…',
      ...
      preview: {
        ...
        sloganPlaceholder: 'a line just for two',
      },
      errors: {
        dateRequired: 'Anniversary is required.',
    ...
    pairJoin: {
      ...
      help: 'The code looks like A1B2-C3D4 — eight characters in two groups. They see it the moment they create the invite.',
      cta: 'Pair up',
      joining: 'Pairing…',
      remaining: '{{n}} more to go',
      ready: 'ready to step in ♥',
    },
    pairWait: {
    ...
    personalize: {
      title: 'Who are you?',
      subtitle: 'A name and a little face',
      nickLabel: 'Your name',
      nickPlaceholder: 'Your name',
      nickIcon: '\u2736',
      colorLabel: 'Pick a vibe',
      ...
      eyebrow: 'we\u2019re all set',
      title: '{{names}},\nwelcome\nhome.',
      titleSelfFallback: 'you',
      titlePartnerFallback: 'them',
      status: 'paired',
      sinceToday: 'since today',
      sinceWithDate: 'since {{date}}',
      kicker: 'together, keep what\u2019s worth keeping \u2665',
      cta: 'Enter Memoura',
      finishing: 'Entering\u2026',
      firstThings: {
        moment: { icon: '\ud83d\udcf7', title: 'first moment', sub: 'save now' },
        letter: { icon: '\u2709\ufe0f', title: 'first letter', sub: 'handwrite' },
        question: { icon: '?', title: 'first Q', sub: 'today' },
      },
    },
    intro: {
      next: 'Next',
