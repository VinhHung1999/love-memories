...
export default function MorePage() {
  ...
  const coupleUpdateMutation = useMutation({
    mutationFn: async () => {
      ...
      await settingsApi.set('app_name', name || 'Memoura');
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      {/* Google Account Link */}
      <div className="mt-4 bg-white rounded-2xl p-4 shadow-sm" data-tour="google-link">
        ...
        {user?.googleId ? (
          ...
          <div>
            <p className="text-xs text-text-light mb-2">Link your Google account for easier sign-in</p>
            <GoogleLogin
