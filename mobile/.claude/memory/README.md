# Memoura Mobile Project Memory

This directory contains structured memories specific to the Memoura mobile project.
...
| `architecture` | Major refactoring, adding new modules, understanding system structure |
