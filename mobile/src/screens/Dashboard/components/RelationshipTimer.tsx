...
export function RelationshipTimer({ duration }: RelationshipTimerProps) {
  ...
  return (
    <Animated.View entering={FadeIn.duration(600)}>
      {/* Duration Card */}
      <View className="rounded-3xl overflow-hidden shadow-md self-stretch">
        <LinearGradient
          ...
          <View className="flex-row items-center justify-center gap-1.5 mb-2.5">
            ...
            <Text className="text-[8px] font-bold text-primary tracking-[1.8px] uppercase">
            ...
            {duration.years > 0 && (
              <>
                <View className="items-center">
                  <Text className="text-[26px] font-bold text-textDark leading-none">
                    {duration.years}
                  </Text>
                  <Text className="text-[8px] font-semibold text-textMid tracking-[1.2px] uppercase mt-0.5">
          ...
          <View className="flex-row items-center justify-center gap-1 mt-2.5">
            <Icon name="heart" size={5} color="#E8788A" />
            <Icon name="heart" size={6} color="#E8788A" />
            <Icon name="heart" size={5} color="#E8788A" />
          </View>
        </LinearGradient>
      </View>
